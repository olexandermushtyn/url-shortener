...
func (s *Storage) SaveUrl(urlToSave string, alias string) (int64, error) {
	...
	if err != nil {
		if sqliteErr, ok := err.(sqlite3.Error); ok && sqliteErr.Code == sqlite3.ErrNo(sqlite3.ErrConstraintUnique) {
...
func (s *Storage) DeleteUrl(deleteUrl string) error {
